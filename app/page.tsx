...
export default function Home() {
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (!choice || (choice === "attending" && !name.trim())) return;
    setSubmitted(true);
  }
            ...
            <div className="rounded-[1.75rem] border border-[#202523]/10 bg-[#fffaf1]/90 p-5 shadow-[0_18px_50px_rgba(41,56,53,0.10)] backdrop-blur sm:p-7">
              {submitted ? (
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  {choice === "attending" && (
                    <div className="mt-5 grid gap-4 sm:grid-cols-[minmax(0,1fr)_126px] lg:grid-cols-1 xl:grid-cols-[minmax(0,1fr)_126px]">
                  ...
                  <button
                    type="submit"
                    disabled={!choice || (choice === "attending" && !name.trim())}
                  ...
                  <p className="mt-3 text-center text-[11px] leading-5 text-[#202523]/48">
                    For this preview, your response stays on this device only.
                  </p>
                </form>
              )}
            </div>
